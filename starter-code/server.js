...
// the proxyGitHub function routes the GitHub request. it will send the request to github, and wait for a response. it is called on the app.get method.
...
// its getting called here. when invoked, it will send the proxyGitHub request to github.
...
// it is being called in the article.js file on the Article.findWhere method. it is selecting the author_id from the articles database.
...
// this is invoked in article.js on Article.allCategories. its grabbing all the categories in the article database.
...
// this is invoked in the article.js file on the truncateTable method. it is deleting all the data from the table in the database.
